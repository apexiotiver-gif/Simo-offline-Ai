...
public class AI_emotions_8 {
    ...
    public AI_emotions_8() { setupData(); }
    ...
    private void setupData() {
        questions.add("prompt{question:word8_0a word8_0b}"); answers.add("prompt{answer:word8_0c word8_0d}"); tokens.add(20);
        questions.add("prompt{question:word8_1a word8_1b}"); answers.add("prompt{answer:word8_1c word8_1d}"); tokens.add(21);
        questions.add("prompt{question:word8_2a word8_2b}"); answers.add("prompt{answer:word8_2c word8_2d}"); tokens.add(22);
        questions.add("prompt{question:word8_3a word8_3b}"); answers.add("prompt{answer:word8_3c word8_3d}"); tokens.add(23);
        questions.add("prompt{question:word8_4a word8_4b}"); answers.add("prompt{answer:word8_4c word8_4d}"); tokens.add(24);
    }
}
