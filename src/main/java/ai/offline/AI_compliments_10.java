package ai.offline;
import java.util.*;
public class AI_compliments_10 {
    ...
    public AI_compliments_10() { setupData(); }
    ...
    private void setupData() {
        questions.add("prompt{question:word10_0a word10_0b}"); answers.add("prompt{answer:word10_0c word10_0d}"); tokens.add(20);
        questions.add("prompt{question:word10_1a word10_1b}"); answers.add("prompt{answer:word10_1c word10_1d}"); tokens.add(21);
        questions.add("prompt{question:word10_2a word10_2b}"); answers.add("prompt{answer:word10_2c word10_2d}"); tokens.add(22);
        questions.add("prompt{question:word10_3a word10_3b}"); answers.add("prompt{answer:word10_3c word10_3d}"); tokens.add(23);
        questions.add("prompt{question:word10_4a word10_4b}"); answers.add("prompt{answer:word10_4c word10_4d}"); tokens.add(24);
    }
}
